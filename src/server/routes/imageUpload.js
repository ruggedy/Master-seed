...
router.post('/', multer({dest: './uploads'}).array('uploads[]', 12), function (req, res, next) {
	...
	aws.config.update({accessKeyId: 'AKIAJUAN7PH4VYU6ZRKA', secretAccessKey: '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', region: 'eu-west-1'})
	var s3 = new aws.S3({params: {Bucket: 'damishtestbucket'}});
